...
public:
	...
	virtual void SetPlayPosByte(const DWORD platposbyte) = 0;
...
public:
	...
	virtual void SetPlayPosByte(const DWORD platposbyte){ m_pDSBuffer->SetCurrentPosition(platposbyte); }
...
public:
	...
	virtual void SetPlayPosByte(const DWORD platposbyte){}
